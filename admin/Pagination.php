...
class Pagination 
{
	...
	function create_links()
	{
		...
		if ($loopStart != 1){
			$output .= sprintf('<li class="disabledpage" style="float:left; list-style-type: none;"><a href="' . $link . '">&#171;</a>&nbsp;&nbsp;</li>', '1');
		}
		
		if ($currentPage > 1){
			$output .= sprintf('<li class="nextpage" style="float:left; list-style-type: none;"><a href="' . $link . '">Previous </a>&nbsp;&nbsp;</li>', $currentPage - 1);
		}
		
		for ($i = $loopStart; $i <= $loopEnd; $i++)
		{
			if ($i == $currentPage){
				$output .= '<li class="currentpage" style="float:left; list-style-type: none;">&nbsp;&nbsp; ' . $i . ' &nbsp;&nbsp;</li> ';
			} else {
				$output .= sprintf('<li style="float:left; list-style-type: none;">&nbsp;&nbsp;<a href="' . $link . '"> ', $i) . $i . ' &nbsp;&nbsp;</a></li> ';
			}
		}

		if ($currentPage < $totalPages){
			$output .= sprintf('<li class="nextpage" style="float:left; list-style-type: none;"><a href="' . $link . '">Next</a>&nbsp;&nbsp;</li>', $currentPage + 1);
		}
		
		if ($loopEnd != $totalPages){
			$output .= sprintf('<li class="nextpage" style="float:left"><a href="' . $link . '">&#187;</a>&nbsp;&nbsp;</li>', $totalPages);
		}
		return '<ul id="pagination-flickr" style="list-style-type: none;">&nbsp;&nbsp;' . $output . '&nbsp;&nbsp;</ul>';
	}
}
